...
from src.array_util import data_to_sparse, get_max_row_column
...
def get_train_global(train, val, test, is_eval=False):
    ...
    :param is_eval: Boolean, that defines if this data will be used for evaluation or tuning. The difference is that
